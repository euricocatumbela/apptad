...
/* harmony import */ var _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @aws-amplify/auth */ "./node_modules/@aws-amplify/ui-components/node_modules/@aws-amplify/auth/lib-esm/index.js");
...
var componentFieldMapping = {
    username: function (ff) { return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-username-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
    password: function (ff) { return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-password-field", { label: ff.label, placeholder: ff.placeholder, hint: ff.hint, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
    email: function (ff) { return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-email-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
    code: function (ff) { return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-code-field", { label: ff.label, placeholder: ff.placeholder, hint: ff.hint, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: Object.assign(Object.assign({}, ff.inputProps), { min: '0' }), disabled: ff.disabled })); },
    // TODO: Will create a phone field component once the dial country code component is in
    phone_number: function (ff) { return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-phone-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled, dialCode: ff.dialCode })); },
    default: function (ff) { return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
};
...
var AmplifyAuthFields = /** @class */ (function () {
    ...
    AmplifyAuthFields.prototype.render = function () {
        return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "auth-fields" }, this.constructFormFieldOptions(this.formFields));
    };
...
var AmplifyCountryDialCode = /** @class */ (function () {
    ...
    AmplifyCountryDialCode.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-select", { fieldId: this.fieldId, options: this.options, handleInputChange: this.handleInputChange, selected: this.selectedDialCode }));
    };
...
var AmplifyEmailField = /** @class */ (function () {
    ...
    AmplifyEmailField.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", { fieldId: this.fieldId, label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.label), placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.placeholder), type: "email", required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    };
...
var AmplifyFormSection = /** @class */ (function () {
    ...
    AmplifyFormSection.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("form", { onSubmit: this.handleSubmit }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-section", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "amplify-form-section-header" }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "form-section-header" }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", { class: "header", "data-test": this.testDataPrefix + '-header-section' }, this.headerText), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "subtitle" }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "subtitle" }))))), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "amplify-form-section-footer" }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "form-section-footer" }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { type: "submit", "data-test": this.testDataPrefix + '-' + this.testDataPrefix + '-button' }, this.loading ? Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-loading-spinner", null) : Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, this.submitButtonText)), this.secondaryFooterContent))))));
    };
...
var AmplifyPasswordField = /** @class */ (function () {
    ...
    AmplifyPasswordField.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", { type: "password", fieldId: this.fieldId, label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.label), placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.placeholder), hint: this.hint, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    };
...
var AmplifyPhoneField = /** @class */ (function () {
    ...
    AmplifyPhoneField.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", { label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.label), hint: this.hint, required: this.required }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "phone-field", slot: "input" }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-country-dial-code", { dialCode: this.dialCode, handleInputChange: this.handleInputChange }), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-input", { fieldId: this.fieldId, type: "tel", handleInputChange: this.handleInputChange, placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.placeholder), name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    };
...
var AmplifySelect = /** @class */ (function () {
    ...
    AmplifySelect.prototype.contructSelectOptions = function (opts) {
        ...
        opts.forEach(function (opt) {
            content.push(Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("option", { value: opt.value, selected: opt.value === _this.selected }, opt.label));
        });
        return content;
    };
    AmplifySelect.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("select", { name: this.fieldId, id: this.fieldId, class: "select", onChange: this.handleInputChange }, this.selectOptions));
    };
...
var AmplifyUsernameField = /** @class */ (function () {
    ...
    AmplifyUsernameField.prototype.render = function () {
        return (Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", { fieldId: this.fieldId, label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.label), placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.placeholder), required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    };
